...
(function($) {
	...
	jQselectable.prototype = {
		...
		build: function() {
			...
			this.mat.show();
			this.matHeight = this.mat.attr('offsetHeight')||this.mat.height();
			this.mat.hide();
		},
		...
		bind_events: function() {
			...
			$('a', this.mat).click(function() {
				var self = $(this);
				var oldName=_this.m_text.text();
				_this.m_text.text(self.attr('name'));
				if(oldName!="")
					$('option[value="'+oldName+'"]', _this.target).removeAttr('selected');
