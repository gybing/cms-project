...
<head>
	...
	<script type="text/javascript">
		...
		function savePrintTemp(){
			...
			html = ht.html();
			$.ajax({
				url:"${ctxPath}/topic/ajax/saveOrderTemplet",
				data:{"templet":html},
				type:"post",
				dataType:"json",
				success:function(data){
		...
		function printTemp(){
			$.ajax({
				url:"${ctxPath}/topic/ajax/printOrder",
		...
		<div class="ibox">
			<div class="ibox-content">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div id="print_div" style="margin-top: 10px;width:1000px;height:370px;">
							<table id="print_table">
								...
								<tr>
									<td id="td10"><label id="SCHEDULE_REMARK"></label></td>
									<td id="td11"><label id="TO_PORT" style="width:100%"></label></td>
									<td id="td12"><label id="BOX_TAKE"></label></td>
								</tr>
								<tr>
									<td id="td13"><label id="NO"></label></td>
									<td id="td14"><label id="SEAL_NO"></label></td>
									<td id="td15"><label id="CARGO_REMARK"></label></td>
								</tr>
							</table>
						</div>
					</div>
