                    ...
                    <div class="ibox-content widget-content nopadding">
                       <form id="areaEditForm" method="post" action="#" data-id="${param.pdataId}" callback="searchForm()" class="form-horizontal">
                            ...
                            <div class="form-group form-group-sm">                                   
                               <label class="col-sm-2 control-label" for="account">地点名称:</label>
                               <div class="col-sm-2">
                                  	<input id="areaName" name="areaName" value="${param.areaName }"  type="text" class="form-control required" maxlength="100">
                                	<span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 必填项</span>
                                </div>
                               <label class="col-sm-2 control-label" >地点代码:</label>
                               <div class="col-sm-2">
                                   	<input id="areaCode" style="width: 150px;" class="form-control required" name="areaCode" maxlength="20">
                                	<span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 必填项</span>
                                </div>
                           </div>
                           ...
                           <div class="form-group form-group-sm">
                               ...
                               <div class="col-sm-2">
	                            	...
	                            	<table>
									  <tr>
									    <td>
									    	<select id="area_edit_addr_prov" name="area_edit_addr_prov" style="width: 67px">
		                                        <option value="">请选择</option>
		                                    </select>
										</td>
									    <td style="padding-left: 15px;">
									    	<select id="area_edit_addr_city" name="area_edit_addr_city" style="width: 68px">
		                                        <option value="">请选择</option>
		                                    </select>
									    </td>
									  </tr>
	                     		...
	                     		<label class="col-sm-2 control-label" >定位地址:</label>
                              	<div class="col-sm-2">
                               		<input id="areaAddr" name="areaAddr"  type="text" class="form-control required" 
                                    onclick="selectAreaOnMap()" isFirst="1" maxlength="20" readonly="readonly" placeholder="点击弹出地图选择地址">
                           ...
                           <div class="form-group"><br></div>
                           <div class="form-group form-group-sm">
                               <label class="col-sm-2 control-label" >助记器:</label>
	                           	<div class="col-sm-2">
	                            	<input id="cnaxxme" name="namxxe"  maxlength="20" type="text" class="form-control" >
                                </div>
                                <label class="col-sm-2 control-label">所属调度中心:</label>
                                <div class="col-sm-2">
                           ...
                           <div class="form-group form-group-sm">
                               ...
                               <div class="col-sm-8">
                                   <input id="remark" name="remark"  type="text" class="form-control"  maxlength="200">
                                </div>
                           </div>
                           <div class="form-group"><br></div>
                           <div class="form-group"><br></div>
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-sm-4">
                                       ...
                                       <input id="matouCheckBox" name="matouCheckBox" type="checkbox" value="" onclick="clickCheckBox('matou')"> <i></i>码头
                                    </div>
                                    <div class="col-sm-4">
									   <input id="duichang" type="hidden" name="duichang" value="0"/>
                                       <input id="duichangCheckBox" type="checkbox" value="" name="duichangCheckBox" onclick="clickCheckBox('duichang')" > <i></i> 堆场
                                    </div>
                                    <div class="col-sm-4">
									   <input id="cangku" type="hidden" name="cangku" value="0"/>
                                       <input id="cangkuCheckBox" type="checkbox" value="" name="cangkuCheckBox" onclick="clickCheckBox('cangku')"> <i></i> 仓库
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-sm-4">
                                       ...
                                       <input id="tixiangmatouCheckBox" type="checkbox" value="" name="tixiangmatouCheckBox" onclick="clickCheckBox('tixiangmatou')"> <i></i>提箱码头
                                    </div>
                                    <div class="col-sm-4">
									   <input id="tuochedidian" type="hidden" name="tuochedidian" value="0"/>
                                       <input id="tuochedidianCheckBox" type="checkbox" value="" name="tuochedidianCheckBox" onclick="clickCheckBox('tuochedidian')"> <i></i>拖车地点
                                    </div>
                                    <div class="col-sm-4">
									   <input id="chengshidiqu" type="hidden" name="chengshidiqu" value="0"/>
                                       <input id="chengshidiquCheckBox" type="checkbox" value="" name="chengshidiquCheckBox" onclick="clickCheckBox('chengshidiqu')"> <i></i>城市/地区
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-sm-4">
                                       ...
                                       <input id="fanxiangmatouCheckBox" type="checkbox" value="" name="fanxiangmatouCheckBox" onclick="clickCheckBox('fanxiangmatou')"> <i></i>返箱码头
                                    </div>
                                    <div class="col-sm-4">
									   <input id="chezhan" type="hidden" name="chezhan" value="0"/>
                                       <input id="chezhanCheckBox" type="checkbox" value="" name="chezhanCheckBox" onclick="clickCheckBox('chezhan')"> <i></i>车站
                                    </div>
                                    <div class="col-sm-4">
									   <input id="haiguankouan" type="hidden" name="haiguankouan" value="0"/>
                                       <input id="haiguankouanCheckBox" type="checkbox" value="" name="haiguankouanCheckBox" onclick="clickCheckBox('haiguankouan')"> <i></i>海关口岸
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                               <label class="col-sm-2 control-label"></label>
                                <div class="col-sm-8">
                                    <div class="col-sm-4">
                                        ...
                                        <input id="shifazhanCheckBox" type="checkbox" value="" name="shifazhanCheckBox" onclick="clickCheckBox('shifazhan')"> <i></i>始发站
                                    </div>
                                    <div class="col-sm-4">
										<input id="mudizhan" type="hidden" name="mudizhan" value="0"/>
                                        <input id="mudizhanCheckBox" type="checkbox" value="" name="mudizhanCheckBox" onclick="clickCheckBox('mudizhan')"> <i></i>目的站
                                    </div>
                                    <div class="col-sm-4">
										<input id="bianjingzhan" type="hidden" name="bianjingzhan" value="0"/>
                                        <input id="bianjingzhanCheckBox" type="checkbox" value="" name="bianjingzhanCheckBox" onclick="clickCheckBox('bianjingzhan')"> <i></i>边境战
                                    </div>
                                </div>
                           </div>
                           <div class="form-group"><br></div>
                           <div class="form-group form-group-sm">
                               <div class="col-sm-4 col-sm-offset-5">
                                   ...
                                   <button class="btn btn-primary" type="button" onclick="submitEditAreaForm()"><i class="fa fa-check"></i>提 交</button>
    	...
    	$(function(){
    		$("#areaEditForm").validate({
				submitHandler : function(form) {
					$.ajax({
						url:"${ctxPath}/topic/ajax/addArea",
						dataType:"json",
						data : $(form).serialize(),
						type:"post",
