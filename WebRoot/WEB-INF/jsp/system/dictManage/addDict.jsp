...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
		<form id="add_dict_info_form" method="post" action="#" data-id="" callback="" class="form-horizontal">
			<div class="ibox">
					...
					<div class="panel panel-default" style="margin-top: 5px;">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="code" name="code" maxlength="14" type="text" aria-required="true" />
									<span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 必填项</span>
								</div>
								<label class="col-sm-1 control-label">对应文本:</label>
								<div class="col-sm-3">
									<input id="text" name="text" maxlength="14" type="text" aria-required="true" />
									<span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 必填项</span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input id="seq" name="seq" value="0" maxlength="14" type="text" aria-required="true" />
								</div>
								<label class="col-sm-1 control-label">父类编码:</label>
								<div class="col-sm-3">
									<input id="parent_code" name="parent_code" maxlength="14" type="text" aria-required="true" />
								</div>
							</div>
						</div>
					</div>
...
$(function() {
	$("#add_dict_info_form").validate({
		submitHandler : function(form) {
			$.ajax({
				url : "${ctxPath }/topic/ajax/addDictType",
				dataType : "json",
				data : $(form).serialize(),
				type : "post",
