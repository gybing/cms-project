...
<form id="menuInfoAddpForm" method="post" action="" class="form-horizontal m-t">
    <input type="hidden" id="A_MENU_CODE" name="MENU_CODE" />
	<input type="hidden" id="A_PARENT_MENU_ID" name="PARENT_MENU_ID" value="0"/>
	<input type="hidden" id="A_URL_ID" name="URL_ID" value=""/>
	<input type="hidden" id="A_MENU_PATH" name="MENU_PATH" value=""/>
	
    <div class="form-group">
        <label class="col-sm-2 control-label">菜单名称</label>
        <div class="col-sm-10">
            <input type="text" class="form-control required" id="A_MENU_NAME" name="MENU_NAME" minlength="2">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="radio i-checks">
		        <label><input type="radio" value="1" name="MENU_TYPE"> <i></i> 链接</label>
		        <label><input type="radio" checked value="0" name="MENU_TYPE"> <i></i> 文件夹</label>
		    </div>
        </div>
    </div>
    <div class="hr-line-dashed"></div>
